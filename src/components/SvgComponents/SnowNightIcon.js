...
const SnowNightIcon = () => {
  return (
    <svg aria-hidden="true" role="img" width="200" height="200" preserveAspectRatio="xMidYMid meet" viewBox="0 0 48 48">
